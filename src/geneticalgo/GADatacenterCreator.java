...
public class GADatacenterCreator {
	...
	public static Datacenter createDatacenter(String name) {
		...
		List<Pe> peList1 = new ArrayList<Pe>();					// a list to store PEs or CPUs/Cores for 1 Host
		List<Pe> peList2 = new ArrayList<Pe>();					// for 2nd host
		List<Pe> peList3 = new ArrayList<Pe>();					// for 3rd host
		
		int mips = 750000;

		// Create PEs and add these into the list.
		for(int id = 0; id < 7; id++) {							// for 3 octa-core machines
